...
export default function OrderCard({ order }: OrderCardProps) {
    ...
    return (
        <div className="flex flex-col md:flex-row items-stretch border rounded-xl shadow-sm bg-white overflow-hidden">
            ...
            <div className="flex flex-row md:flex-col items-center md:items-start bg-blue-50 px-4 py-4 md:w-36 gap-4 md:gap-2 border-b md:border-b-0 md:border-r border-blue-100">
                        ...
                        <div key={idx} className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="font-medium group-hover:underline group-hover:text-blue-700 transition-colors text-base">
                                        {item.title}
                                    </div>
