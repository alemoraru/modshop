                ...
                <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-4 max-w-5xl mx-auto">
                    {categories.map((category) => (
                        <Link
                            ...
                            className="border border-gray-200 rounded-2xl shadow p-6 transition-all duration-200 hover:scale-105 hover:border-blue-500 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                        >
